    ...
    return (
        <div className='divider'>
            <ul className='unorder'>
                <li className='black'>LOGO</li>
                <li className='festname'>FEST NAME</li>
                <li className='grey'><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
